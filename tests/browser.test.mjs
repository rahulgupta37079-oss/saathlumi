...
await page.goto(base+'/pricing',{waitUntil:'networkidle'});assert.match(await page.locator('.pricing-grid').innerText(),/₹299/);assert.match(await page.locator('.pricing-grid').innerText(),/Free/);checks++;
